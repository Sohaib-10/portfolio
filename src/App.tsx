    ...
    >
      <div className="container mx-auto px-6 flex justify-center">
        <motion.div
          ...
          className={`flex items-center gap-2 p-2 rounded-full border pointer-events-auto transition-all duration-500 ${isScrolled
        ...
        >
          ...
          <a href="/Sohaib_Resume.pdf" download="Sohaib_Resume.pdf">
            <motion.button
        ...
        <section id="about" className="py-20 md:py-32">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:auto-rows-[250px]">
              ...
              >
                <img
                  src="WhatsApp Image 2026-04-22 at 11.55.21 PM.jpeg"
                  alt="Sohaib Tausif"
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <ProjectCard
                ...
                delay={0}
                imageUrl="/Gemini_Generated_Image_mzzqnfmzzqnfmzzq.png"
              ...
              <ProjectCard
                ...
                delay={0.1}
                imageUrl="/WhatsApp Image 2026-04-24 at 12.18.24 AM.jpeg"
                objectPosition="center 10%"
              ...
              <ProjectCard
                ...
                delay={0.2}
                imageUrl="/Gemini_Generated_Image_9re6gf9re6gf9re6.png"
              ...
              <ProjectCard
                ...
                delay={0.3}
                imageUrl="/WhatsApp Image 2026-04-24 at 12.31.42 AM.jpeg"
                objectPosition="center 10%"
